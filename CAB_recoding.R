...
KZ_data$sm_disagreement_politics_n_sc = rescale(KZ_data$sm_disagreement_politics_n, to = c(1, 0))
KZ_data$sm_disagreement_news_n_sc = rescale(KZ_data$sm_disagreement_news_n, to = c(1, 0))
KZ_data$sm_disagreement_issues_n_sc = rescale(KZ_data$sm_disagreement_issues_n, to = c(1, 0))
...
KG_data$sm_disagreement_politics_n_sc = rescale(KG_data$sm_disagreement_politics_n, to = c(1, 0))
KG_data$sm_disagreement_news_n_sc = rescale(KG_data$sm_disagreement_news_n, to = c(1, 0))
KG_data$sm_disagreement_issues_n_sc = rescale(KG_data$sm_disagreement_issues_n, to = c(1, 0))
...
GA_data$sm_disagreement_politics_n_sc = rescale(GA_data$sm_disagreement_politics_n, to = c(1, 0))
GA_data$sm_disagreement_news_n_sc = rescale(GA_data$sm_disagreement_news_n, to = c(1, 0))
GA_data$sm_disagreement_issues_n_sc = rescale(GA_data$sm_disagreement_issues_n, to = c(1, 0))
...
TJ_data$sm_disagreement_politics_n_sc = rescale(TJ_data$sm_disagreement_politics_n, to = c(1, 0))
TJ_data$sm_disagreement_news_n_sc = rescale(TJ_data$sm_disagreement_news_n, to = c(1, 0))
TJ_data$sm_disagreement_issues_n_sc = rescale(TJ_data$sm_disagreement_issues_n, to = c(1, 0))
...
UZ_data$sm_disagreement_politics_n_sc = rescale(UZ_data$sm_disagreement_politics_n, to = c(1, 0))
UZ_data$sm_disagreement_news_n_sc = rescale(UZ_data$sm_disagreement_news_n, to = c(1, 0))
UZ_data$sm_disagreement_issues_n_sc = rescale(UZ_data$sm_disagreement_issues_n, to = c(1, 0))
